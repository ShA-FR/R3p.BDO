...
namespace R3p.bdo.GameInternals.Structs.ItemMarket
{
    public class MarketItemData : MemoryObject
    {
        ...
        public ItemData ItemData => new ItemData(ReadPointer8b(0x00));      //updated
        public long x0038_RecentPrice => ReadInt64(0x0038);
        public long x0048_MaxPrice => ReadInt64(0x008);     //updated
        public long x0050_MinPrice => ReadInt64(0x0010);    //updated
