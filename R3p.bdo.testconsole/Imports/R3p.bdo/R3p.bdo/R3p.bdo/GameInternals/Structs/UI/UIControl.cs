...
namespace R3p.bdo.GameInternals.Structs.UI
{
    public class UIControl : MemoryObject
    {
        ...
        public UIControl x0008_PTR_Parent1 => new UIControl(ReadPointer8b(0x138));      //updated
        public UIControl x0010_PTR_Parent2 => new UIControl(ReadPointer8b(0x140));      //updated
        public string x0018_Name => GetName();  //updated
        public List<UIControl> Children => GetChilds(); //updated
        public int x0038_Key => ReadInt32(0x0038);
        //public byte x003C_isNotFront => ReadByte(0x003C);
        public byte x003D_State => ReadByte(0x24D);     //updated
        //public byte x0041_State => ReadByte(0x0041);
        public byte x0044_InteractState => ReadByte(0x254);     //updated
        ...
        public float[] x0054_ScreenPos => ReadVec2(0x1FC);      //updated
        ...
        public long x0288_ListChildControls => ReadPointer8b(0xD0);     //updated
        public long x0290_ListChildControlsEnd => ReadPointer8b(0xD8);  //updated
        ...
        public string x03B0_Text => GetText();      //updated
        ...
        {
            _bText = ReadStringUnicode(0x2E8);

                if (_bText.Length == 0)
                    _bText = ReadStringUnicode(ReadPointer8b(0x2E8));
        ...
        {
            Write(ReadPointer8b(0x2E8), Encoding.Unicode.GetBytes(text));
        }
    }
}
